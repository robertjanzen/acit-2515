...
class StateModel(Observable):
    ...
    def state(self, input_value):
        ...
        self.notifyAll(state=input_value)
    ...
    def entry(self, input_value):
        ...
        self.notifyAll(entry=input_value)
    ...
    def input(self, input_value):
        ...
        self.notifyAll(input=input_value)
    ...
    def usr_record(self):
        """
            Getter for the instance variable self._user_accounts
    ...
    def usr_record(self, input_value):
        """
            Setter for the instance variable self._user_accounts
            
        Args:
            input_value:
                New value for self._user_accounts
                
        Returns:
            None
        """
        self._user_accounts = input_value
